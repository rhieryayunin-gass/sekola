...
export type CurriculumScale = CurriculumOption & { program_id: string; kind: "NUMERIC" | "RUBRIC" | "LETTER" | "DESCRIPTOR"; minimum: number | null; maximum: number | null; labels: string[]; criteria?: string; rubric_dimensions?: string[] };
...
export type CurriculumEvidence = { rubric_results?: Record<string,string>; id: string; course_id: string; student_id: string; outcome_id: string; scale_id: string; assignment_id?: string; exam_id?: string; score: number | null; descriptor: string | null; feedback: string; assessed_at: string; status: "DRAFT" | "PUBLISHED"; assessment_context: { program: CurriculumProgram; outcome: CurriculumOutcome; scale: CurriculumScale; subject: CurriculumOption } };
