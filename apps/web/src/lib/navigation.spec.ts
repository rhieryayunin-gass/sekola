...
describe('approved role navigation',()=>{
 const expected:Record<string,string[]>={PRINCIPAL:['dashboard','team','approval','gallery'],STAFF:['dashboard','academic','team','finance','gallery'],TEACHER:['dashboard','academic','attendance','learning','exams','team','gallery'],STUDENT:['dashboard','academic','learning','exams','team','gallery'],PARENT:['dashboard','learning','exams','team','finance','gallery']};
