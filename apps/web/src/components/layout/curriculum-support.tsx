...
const curricula = [
  ...
  { name: "Pearson", subtitle: ["INTERNASIONAL", "INTERNATIONAL"], logo: "pearson-part8.png", href: "https://qualifications.pearson.com/en/qualifications.html" },
  { name: "IB", subtitle: ["PYP · MYP · DP · CP", "PYP · MYP · DP · CP"], logo: "ib-clean.webp", href: "https://www.ibo.org/programmes/" },
  { name: "Madrasah", subtitle: ["", ""], logo: "madrasah-part8.png", href: "https://kemenag.go.id/" },
] as const;
