import { Images, BookOpenText, ScanFace, ClipboardPenLine, GraduationCap, PanelsTopLeft, MessagesSquare, LayoutDashboard, WalletCards, BriefcaseBusiness, School, ContactRound, HeartHandshake, ShieldCheck, Presentation } from "lucide-react";
const icons = {gallery:Images,core:PanelsTopLeft,academic:GraduationCap,attendance:ScanFace,learning:BookOpenText,exam:ClipboardPenLine,exams:ClipboardPenLine,finance:WalletCards,team:LayoutDashboard,connect:MessagesSquare,OWNER:ShieldCheck,PRINCIPAL:School,STAFF:BriefcaseBusiness,TEACHER:Presentation,STUDENT:ContactRound,PARENT:HeartHandshake};
