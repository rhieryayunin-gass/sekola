...
export function Landing() {
  ...
  return <main id="ose-main" className="ose-marketing">
    <section className="ose-hero ose-hero-new"><div className="ose-hero-text"><h1>{copy.title}<br/><span>{copy.accent}</span></h1><p className="ose-hero-copy">{copy.intro}</p><a className="ose-contact-link" href="#contact">{copy.contact}<ArrowDown size={18}/></a></div><div className="ose-school-scene"><Image src="/illustrations/hero.webp" alt={locale === "id-ID" ? "Guru dan siswa terhubung dalam lingkungan sekolah digital" : "A teacher and students connected in a digital school"} width={1536} height={1024} preload sizes="(max-width: 760px) 100vw, 55vw"/></div></section>
