...
export function OwnerTenants() {
  ...
  return <OwnerShell><div className="p9-tenant-workspace"><OwnerHeading title="ownerTenant" description="ownerTenantDesc"><Button onClick={() => open(null)}><Plus size={17}/>{t("ownerAddTenant")}</Button></OwnerHeading>
