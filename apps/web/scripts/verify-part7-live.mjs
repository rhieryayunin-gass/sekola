...
try {
  ...
  const tables = ['school_asset_reservations','school_timetable','room_bookings','team_task_comments','team_project_payments','team_project_invoices','team_project_activity','school_project_committees','team_tasks','team_project_members','team_project_settings','team_projects','school_user_credentials','school_user_attendance','attendance_records','school_user_changes','approval_steps','leave_requests','approval_requests','oconnect_messages','oconnect_members','oconnect_conversations','school_cash_entries','school_settlement_accounts', 'school_qualification_results', 'school_setup_suggestions', 'school_setup', 'school_submission_versions', 'school_submission_workflow', 'school_learning_progress', 'school_lesson_versions', 'school_curriculum_evidence', 'school_curriculum_alignments', 'school_assessment_participants', 'school_assessment_designs', 'school_exam_attempts', 'exam_results', 'exam_sessions', 'school_exam_items', 'submissions', 'assignments', 'lessons', 'school_learning_units', 'school_learning_spaces', 'school_curriculum_course_links', 'school_curriculum_enrollments', 'school_curriculum_outcomes', 'school_curriculum_scales', 'school_curriculum_subjects', 'school_curriculum_stages', 'school_curriculum_programs', 'school_ai_generations', 'school_question_items', 'school_question_sets', 'exams', 'courses', 'school_guardians', 'student_assignments', 'teacher_assignments', 'teachers', 'students', 'classrooms', 'subjects', 'semesters', 'academic_years', 'calendars','school_assets','rooms', 'notifications', 'audit_logs', 'school_settings'];
