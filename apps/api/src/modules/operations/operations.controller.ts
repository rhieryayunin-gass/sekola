...
export class OperationsController {
  ...
  @Get("rooms") @RequirePermission("rooms.read") rooms(@Req() request: Request) { return this.service.list(this.userId(request), "rooms"); }
  ...
  @Get("room-bookings") @RequirePermission("room_bookings.read") bookings(@Req() request: Request) { return this.service.list(this.userId(request), "room_bookings"); }
  ...
  @Get("approvals") @RequirePermission("approvals.read") approvals(@Req() request: Request) { return this.service.approvals(this.userId(request)); }
  ...
  @Get("leave-requests") @RequirePermission("leave_requests.read") leaves(@Req() request: Request) { return this.service.list(this.userId(request), "leave_requests"); }
  ...
  @Get("schedule-changes") @RequirePermission("schedule_changes.read") scheduleChanges(@Req() request: Request) { return this.service.list(this.userId(request), "schedule_change_requests"); }
