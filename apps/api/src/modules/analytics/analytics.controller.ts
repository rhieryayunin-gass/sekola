...
export class AnalyticsController {
  ...
  @Get("academic") @RequirePermission("academic_analytics.read") academic(@Req() request: Request, @Query() page: PageDto) { return this.service.academic(this.userId(request), page); }
  @Get("attendance") @RequirePermission("attendance_analytics.read") attendance(@Req() request: Request, @Query() page: PageDto) { return this.service.attendance(this.userId(request), page); }
